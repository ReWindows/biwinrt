//! Windissect-generated Rust FFI bindings for biwinrt.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "5911B9AD2E0AB55E7D22DBF876D0A06A";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 1315543195;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 12] = [98, 105, 119, 105, 110, 114, 116, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 1315543195 { return 0; }
