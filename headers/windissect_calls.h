...
static constexpr wchar_t module_name[12] = {0x0062, 0x0069, 0x0077, 0x0069, 0x006E, 0x0072, 0x0074, 0x002E, 0x0064, 0x006C, 0x006C, 0x0000};
...
if (live_timestamp != 1315543195U || rva >= image_size) return nullptr;
return base + rva;
}
